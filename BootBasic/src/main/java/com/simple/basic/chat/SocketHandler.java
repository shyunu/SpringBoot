...
public class SocketHandler extends TextWebSocketHandler {
    ...
    //다중채팅방을 구현하고 싶다면 다른 객체에서 채팅방 관리할 수 있는 자료구조를 만드세요
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        URI uri = session.getUri(); //URI를 얻음
        if(uri != null) { //값이 있으면
            String query = uri.getQuery(); //쿼리스트링을 얻음
        ...
        //입장메세지
        broadcastMessage(userId + "님이 등장하였습니다!");
    }
...
//        System.out.println(message.getPayload());
        ...
        System.out.println("현재접속자:" + map.size());
